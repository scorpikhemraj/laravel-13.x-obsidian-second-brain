...
#### [Model Booting and Nested Instantiation](#model-booting-and-nested-instantiation)
...
#### [HTTP Client `Response::throw` and `throwIf` Signatures](#http-client-response-throw-and-throwif-signatures)
...
#### [Queued Notifications and Missing Models](#queued-notifications-and-missing-models)
...
#### [Symfony PHP 8.5 Polyfill and Global Function Conflicts](#symfony-polyfill)
