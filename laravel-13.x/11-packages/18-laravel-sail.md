...
Laravel provides amazing testing support out of the box, and you may use Sail's `test` command to run your applications [[10-testing/01-testing-getting-started.md|feature and unit tests]]. Any CLI options that are accepted by Pest / PHPUnit may also be passed to the `test` command:
