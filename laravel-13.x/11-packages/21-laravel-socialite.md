...
Once the user has been retrieved from the OAuth provider, you may determine if the user exists in your application's database and [[06-security/01-authentication.md#authenticate-a-user-instance|authenticate the user]]. If the user does not exist in your application's database, you will typically create a new record in your database to represent the user:
