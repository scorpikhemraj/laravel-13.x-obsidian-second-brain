...
You may write information to the logs using the `Log` [[03-architecture-concepts/04-facades.md|facade]]. As previously mentioned, the logger provides the eight logging levels defined in the [RFC 5424 specification](https://tools.ietf.org/html/rfc5424): **emergency**, **alert**, **critical**, **error**, **warning**, **notice**, **info** and **debug**:
...
If you need to share log context while processing queued jobs, you may utilize [[05-digging-deeper/17-queues.md#job-middleware|job middleware]].
...
All of your "tap" classes are resolved by the [[03-architecture-concepts/02-service-container.md|service container]], so any constructor dependencies they require will automatically be injected.
