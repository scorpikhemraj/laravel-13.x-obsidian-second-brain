...
In Laravel, exception reporting is used to log exceptions or send them to an external service like [[04-the-basics/14-logging.md|Sentry](https://github.com/getsentry/sentry-laravel) or [Flare](https://flareapp.io). By default, exceptions will be logged based on your [logging]] configuration. However, you are free to log exceptions however you wish.
...
To customize the exception reporting for a given exception, you may also utilize [[04-the-basics/13-error-handling.md#renderable-exceptions|reportable exceptions]].
...
When messages are written to your application's [[04-the-basics/14-logging.md|logs]], the messages are written at a specified [[04-the-basics/14-logging.md#log-levels|log level]], which indicates the severity or importance of the message being logged.
...
You may type-hint any required dependencies of the `report` method and they will automatically be injected into the method by Laravel's [[03-architecture-concepts/02-service-container.md|service container]].
