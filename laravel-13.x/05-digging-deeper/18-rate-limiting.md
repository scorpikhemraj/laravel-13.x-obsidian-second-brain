...
If you are interested in rate limiting incoming HTTP requests, please consult the [[04-the-basics/01-routing.md#rate-limiting|rate limiter middleware documentation]].
