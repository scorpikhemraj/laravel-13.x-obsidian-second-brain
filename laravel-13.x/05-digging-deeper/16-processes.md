...
Within this closure, you may define the processes that belong to the pool. Once a process pool is started via the `start` method, you may access the [[05-digging-deeper/04-collections.md|collection]] of running processes via the `running` method:
